...
use crate::render::passes::gpu_resources::world_uniforms::ChunkStorageBindGroupLayout;
use crate::render::passes::shader_registry::SHADOW_VERT_SHADER_HANDLE;
use crate::render::passes::shadow_pass::gpu_resources::SHADOW_DEPTH_FORMAT;
...
impl FromWorld for ShadowPassPipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let shadow_pass_depth_stencil = Some(DepthStencilState {
