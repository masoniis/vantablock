...
fn main() {
    // tint grass textures
    tint_image("assets/client/texture/faithful/grass_top.png");
    tint_image("assets/client/texture/rhinestone/grass_top.png");

    // generate transparent water texture
    create_transparent_water("assets/client/texture/faithful/water.png");
    create_transparent_water("assets/client/texture/rhinestone/water.png");
}
